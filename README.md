# Raqib — AI-Assisted IoT Security Compliance Platform


It discovers simulated IoT devices on an isolated Docker network, fingerprints them,
assesses them against the Saudi NCA **CGIoT-1:2024** guidelines, enriches findings with
CVE / CISA-KEV intelligence, scores risk, checks post-quantum readiness, and generates
remediation blueprints and an executive summary — all from one dashboard.
