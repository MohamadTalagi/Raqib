...
def test_every_test_id_has_the_expected_pipeline_phase():
    ...
    expected = {
        ...
        "TEST-AUTH-DEFAULT-CREDS": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-HTTP-HEADERS": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-AUTH-ANON-ACCESS": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-AUTH-SESSION": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-ADMIN-UNAUTH": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-MQTT-OPEN": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-TLS-CONFIG": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-NET-PKTCAPTURE": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-FW-VERSION": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-FW-CONFIG": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-FW-SECRETS": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-FW-APIKEY": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-FW-CERTKEY": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-FW-UPDATESCRIPT": PIPELINE_PHASE_NCA_COMPLIANCE,
        ...
        "TEST-PHYSICAL-TAMPER-STATUS": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-TLS-CLIENT-AUTH": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-SECURITY-LOG-ENDPOINT": PIPELINE_PHASE_NCA_COMPLIANCE,
        "TEST-MONITORING-ENDPOINT": PIPELINE_PHASE_NCA_COMPLIANCE,
